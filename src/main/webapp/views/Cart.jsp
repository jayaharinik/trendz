...
body {
	background-image: url("http://www.planwallpaper.com/static/images/tree-on-a-moonlight-twitter-background.jpg");
...
<body>
	...
	<header>
		<center>
		<h1 style="font-family:monotype corsiva;"><img src="http://cottonwoodbridal.com/About_files/Cottonwood%20Bridal%20girl%20Logo%20Final.jpg?1436816495&s=36d5eceba23d9355349d47697d8069b3	" height="77" width="77" style="font-family: monotype corsiva;" /><b>trendz world</b></h1>
	</center>
...
<div > 
					<h3 style="font-family:monotype corsiva;color:pink;font-size: 1.7em;"><b>Items in your cart</b></h3>
					</div>
<div  ng-app="addToCartApp"  ng-controller = "addToCartCtrl"  ng-init="retrieveCart('${cartId}')">
	 
	 <div >
        <table class="table table-bordered" style="font-family:monotype corsiva;color:yellow;font-size: 1.5em;" >
		  <thead>
			  <tr>
			  <th>Product</th>
				<th >Unit Price</th>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
      ...
      */
      $scope.removeItemFromCart = function (id) {
         $http['delete']('http://localhost:8080/dresses/categoryDropdown/productDisplay/usercart/cart/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8080/dresses/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8080/dresses/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8080/dresses/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
