...
<style>
body {
	background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNjsYh--Gsxd9tfeeC0nEFPUD1-VzKmD2Nr-vDQSThQclHv0OzOA");
...
<div class="container-fluid"  >
		...
		<br>
				...
				<div class="panel-body">
					<form:form class="form-horizontal" action="saveBillingAddress" commandName="billingAddress" style="font-family:monotype corsiva;font-weight: bold;color:yellow;font-size: 1.5em;">
						<div class="form-group">
							<label for="" class="control-label col-sm-2">Address Line 1</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="" class="control-label col-sm-2">Address Line 2</label>
							<div class="col-sm-10">
